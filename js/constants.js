...
export const CHARACTERS = [
    ...
    // RE-NAMED & UPDATED:
    { id: 'baller', name: 'Baller', color: '#fdb927', accent: '#552583' }, // War Hoopster
    { id: 'lifeguard', name: 'Lifeguard', color: '#ff2222', accent: '#ffff88' }, 
    { id: 'rapper', name: 'Rapper', color: '#000000', accent: '#ffd700' }, // War Vocalist
    { id: 'rap_icon', name: 'Rap Icon', color: '#ffffff', accent: '#3366cc' }, // War Rapper
